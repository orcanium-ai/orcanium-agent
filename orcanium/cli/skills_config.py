"""
Skills configuration for Orcanium Agent.
`orcanium skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.Orcanium/config.yaml under:
...
from orcanium.cli.config import cfg_get, load_config, save_config
from orcanium.cli.colors import Colors, color
from orcanium.cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `orcanium skills`."""
    from orcanium.cli.curses_ui import curses_checklist
