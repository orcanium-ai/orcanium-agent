...
``cli.py``'s ``OrcaniumCLI`` class. ``OrcaniumCLI`` inherits ``CLICommandsMixin`` so
...
from orcanium.channel.compat import display_orcanium_home, is_termux as _is_termux_environment
from orcanium.cli.browser_connect import (
...
class CLICommandsMixin:
    ...
    def _handle_rollback_command(self, command: str):
        ...
        """
        from orcanium.app.tools.checkpoint_manager import format_checkpoint_list
        ...
        if not mgr.enabled:
            ...
            print("  Enable with: Orcanium --checkpoints")
    ...
    def _handle_snapshot_command(self, command: str):
        """Handle /snapshot — lightweight state snapshots for Orcanium config/state.
        ...
        """
        from orcanium.cli.backup import (
        ...
        if subcmd in {"list", "ls"}:
            ...
            if not snaps:
                ...
                return
            print(f"  State snapshots ({display_orcanium_home()}/state-snapshots/):\n")
    ...
    def _handle_paste_command(self):
        ...
        from orcanium.cli.clipboard import has_clipboard_image
    ...
    def _handle_image_command(self, cmd_original: str):
        ...
        if _remainder:
            ...
            _cprint(f"  {_DIM}Tip: type your next message, or run orcanium chat -q --image {_termux_example_image_path(image_path.name)} \"What do you see?\"{_RST}")
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in orcanium.cli/colors.py
    ...
    def _handle_handoff_command(self, cmd_original: str) -> bool:
        ...
        if not pcfg or not pcfg.enabled:
            _cprint(f"  Platform '{platform_name}' is not configured/enabled in the channel.")
            return True
        ...
        try:
            ...
            pass
        _cprint("  Timed out waiting for the channel. Is `orcanium gateway` running?")
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if not target:
            ...
            if self._show_recent_sessions(reason="resume"):
                ...
                return
            _cprint("  Tip:   Use /history or `orcanium sessions list` to find sessions.")
            return
        ...
        if target.isdigit():
            ...
            from orcanium.cli.main import _resolve_session_by_name_or_id
        ...
        if not session_meta:
            ...
            _cprint("  Use /history or `orcanium sessions list` to see available sessions.")
            return
        ...
        if self.agent:
            ...
            if hasattr(self.agent, "_todo_store"):
                try:
                    from orcanium.app.tools.todo_tool import TodoStore
    ...
    def _handle_branch_command(self, cmd_original: str) -> None:
        ...
        try:
            self._session_db.create_session(
                ...
                source=os.environ.get("ORCANIUM_SESSION_SOURCE", "cli"),
                model=self.model,
                model_config={
    ...
    def _handle_cron_command(self, cmd: str):
        ...
        import shlex
        from orcanium.app.tools.cronjob_tools import cronjob as cronjob_tool
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to orcanium.cli.curator so the CLI and the `orcanium curator`
        ...
        try:
            from orcanium.cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to orcanium.cli.skills_hub."""
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            if out is not None:
                print(out)
                return
        from orcanium.cli.skills_hub import handle_skills_slash
    ...
    def _handle_background_command(self, cmd: str):
        ...
        def run_background():
            ...
            try:
                ...
                if response:
                    try:
                        from orcanium.cli.skin_engine import get_active_skin
                        _skin = get_active_skin()
                        label = _skin.get_branding("response_label", "⚕ Orcanium")
    ...
    def _handle_bundles_command(self, cmd: str) -> None:
        ...
        Mirrors ``orcanium bundles list`` but renders inside the running
        ...
        if not bundles:
            ...
            _cprint(
                f"  {_DIM}Create one with: Orcanium bundles create "
        ...
        _cprint(
            ...
            f"Manage with `orcanium bundles`.{_RST}"
        )
    ...
    def _handle_browser_command(self, cmd: str):
        ...
        if sub.startswith("connect"):
            ...
            try:
                from orcanium.app.tools.browser_tool import _ensure_cdp_supervisor  # type: ignore[import-not-found]
            ...
            if hasattr(self, '_pending_input'):
                self._pending_input.put(
                    ...
                    "just because CDP is connected. This is typically a Orcanium-managed isolated debug "
            ...
            if current:
                ...
                try:
                    from orcanium.app.tools.browser_tool import cleanup_all_browsers, _stop_cdp_supervisor
            ...
            if current:
                ...
                try:
                    from orcanium.app.tools.browser_tool import _get_cloud_provider
                ...
                if provider is not None:
                    ...
                    try:
                        from orcanium.app.tools.browser_tool import _get_browser_engine
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        _cprint(
            ...
            f"Orcanium keeps working until it is, you pause/clear it, or the budget is "
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from orcanium.cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
        ...
        if len(parts) < 2 or not parts[1].strip():
            ...
            print("\n  Usage: /skin <name>")
            print(f"  Custom skins: drop a YAML file in {display_orcanium_home()}/skins/\n")
            return
    ...
    def _handle_footer_command(self, cmd_original: str) -> None:
        ...
        from orcanium.cli.config import load_config
        from orcanium.cli.colors import Colors as _Colors
    ...
    def _handle_busy_command(self, cmd: str):
        """Handle /busy — control what Enter does while orcanium is working.
        ...
        if save_config_value("display.busy_input_mode", arg):
            if arg == "queue":
                behavior = "Enter will queue follow-up input while orcanium is busy."
            elif arg == "steer":
                behavior = "Enter will steer your message into the current run (after the next tool call)."
            else:
                behavior = "Enter will interrupt the current run while orcanium is busy."
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from orcanium.cli.models import _is_anthropic_fast_model
    ...
    def _handle_debug_command(self):
        ...
        from orcanium.cli.debug import run_debug_share
    ...
    def _handle_update_command(self) -> bool:
        """Handle /update — update Orcanium Agent to the latest version.

        In the classic CLI this exits the session and relaunches as
        ``orcanium update`` so the user sees update output directly and gets
        ...
        if is_managed():
            print(f"  ✗ {format_managed_message('update Orcanium Agent')}")
            return False
        ...
        choices = [
            ("once", "Update Now", "exit the current session and update Orcanium Agent"),
            ("cancel", "Cancel", "keep the current session"),
        ]
        raw = self._prompt_text_input_modal(
            title="⚕  Update Orcanium Agent",
            detail="This will exit the current session and run `orcanium update`.",
            choices=choices,
        )
        if raw is None:
