...
Entry point: ``orcanium whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``orcanium.cli/main.py``).
...
Orcanium gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Orcanium to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Orcanium needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Orcanium gateway in another terminal:")
    ...
    print()
    print("  Docs: https://orcanium-agent.orcanium.com/docs/user-guide/")
