...
from orcanium.cli.proxy.adapters.base import UpstreamAdapter
from orcanium.cli.proxy.adapters.orcanium_portal import OrcaniumPortalAdapter
from orcanium.cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``orcanium proxy start --provider <name>`` CLI flag.
ADAPTERS: Dict[str, Type[UpstreamAdapter]] = {
    "orcanium": OrcaniumPortalAdapter,
    "xai": XAIGrokAdapter,
}
