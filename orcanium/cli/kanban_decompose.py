...
Invoked by ``orcanium kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Orcanium Agent board.
...
def _profile_author() -> str:
    """Mirror of ``orcanium.cli.kanban._profile_author``."""
    return (
