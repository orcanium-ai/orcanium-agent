...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_orcanium_agent_browser()
    ),
...
def _has_orcanium_agent_browser() -> bool:
    ...
    # install.sh installs globally into $ORCANIUM_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-OrcaniumHome", str(get_orcanium_home()),
        ]
    else:
