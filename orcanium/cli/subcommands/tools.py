"""``orcanium tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'orcanium tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # orcanium tools list [--platform cli]
    ...
    # orcanium tools disable <name...> [--platform cli]
    ...
    # orcanium tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `orcanium tools` runs after you pick a provider that\n"
