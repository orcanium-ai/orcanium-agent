"""Orcanium CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.Orcanium/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Orcanium Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Orcanium "       # Response box header label
...
.. code-block:: python
    ...
    from orcanium.cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Orcanium Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.Orcanium/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic Orcanium gold/kawaii (the current look)
...
Drop a YAML file in ``~/.Orcanium/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ORCANIUM_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ORCANIUM_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Orcanium — gold and kawaii",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Orcanium Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Orcanium ",
            "prompt_symbol": "❯",
...
def _skins_dir() -> Path:
    ...
    return get_orcanium_home() / "skins"
