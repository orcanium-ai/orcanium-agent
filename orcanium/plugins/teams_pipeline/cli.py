...
from orcanium.app.tools.microsoft_graph_auth import MicrosoftGraphConfigError, MicrosoftGraphTokenProvider
...
def _graph_setup_hint() -> str:
    return f"""
  Microsoft Graph is not configured. Add these to {display_orcanium_home()}/.env:
