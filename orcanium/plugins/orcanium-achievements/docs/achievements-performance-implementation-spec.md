# Orcanium Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.orcanium/plugins/orcanium-achievements/state.json` (existing unlock state)
  - `~/.orcanium/plugins/orcanium-achievements/scan_snapshot.json` (new)
  - `~/.orcanium/plugins/orcanium-achievements/scan_checkpoint.json` (new)
