# Orcanium Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.orcanium/plugins/orcanium-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.orcanium/plugins/orcanium-achievements/scan_checkpoint.json`.
