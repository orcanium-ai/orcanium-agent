...
# orcanium. MCP requires *a* clientInfo; a neutral one satisfies the spec
...
def _new_session_id() -> str:
    ...
    (no orcanium attribution — telemetry policy).
    """
...
class ParallelWebSearchProvider(WebSearchProvider):
    ...
    def is_available(self) -> bool:
        ...
        and the ``orcanium tools`` picker (auto-selecting Parallel for a user who
