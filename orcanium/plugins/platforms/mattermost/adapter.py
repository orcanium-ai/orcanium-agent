...
required — uses aiohttp which is already a Orcanium dependency.
        ...
        for fid in file_ids:
            try:
                ...
                async with self._session.get(
                    ...
                    if resp.status < 400:
                        file_data = await resp.read()
                        from channel.platforms.base import cache_image_from_bytes, cache_document_from_bytes
...
def interactive_setup() -> None:
    ...
    ``orcanium.cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Orcanium delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # orcanium.cli/setup.py::_setup_mattermost function.
        ...
        # adapter" when cron runs separately from the channel.  Mirrors
