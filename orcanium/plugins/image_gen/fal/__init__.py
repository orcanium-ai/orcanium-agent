...
submission, managed-Orcanium-gateway selection, Clarity Upscaler chaining
— lives in :mod:`tools.image_generation_tool`. This plugin reaches into
that module via call-time indirection (``import orcanium.app.tools.image_generation_tool as _it``)
so:
