...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - orcanium_home (str): The active ORCANIUM_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.orcanium``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "orcanium").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'orcanium memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], orcanium_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'orcanium memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``orcanium_home`` is the active ORCANIUM_HOME directory path.
