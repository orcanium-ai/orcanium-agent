# Migrated from orcanium/tools/feishu_doc_tool.py (legacy tree) — imports rewritten.
...
def _check_feishu():
    ...
    # fires at every ``orcanium`` startup during tool-availability
...
def _handle_feishu_doc_read(args: dict, **kwargs) -> str:
    ...
    # Tool handlers run synchroorcaniumly in a worker thread (no running event
