...
# (ORCANIUM_HOME env var changes) are always respected.  The old module-level
# constant was cached at import time and could go stale if a profile switch
# happened after the first import.
def get_memory_dir() -> Path:
    """Return the profile-scoped memories directory."""
    return get_orcanium_home() / "memories"
...
from orcanium.app.tools.threat_patterns import first_threat_message as _first_threat_message
...
class MemoryStore:
    ...
    def _sanitize_entries_for_snapshot(entries: List[str], filename: str) -> List[str]:
        ...
        """
        from orcanium.app.tools.threat_patterns import scan_for_threats
