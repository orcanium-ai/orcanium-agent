...
Trust levels:
  - builtin:   Ships with Orcanium. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.Orcanium/\.env|\~/\.Orcanium/\.env',
     "orcanium_env_access", "critical", "exfiltration",
     "directly references Orcanium secrets file"),
    ...
    (r'\.Orcanium/config\.yaml|\.Orcanium/SOUL\.md',
     "orcanium_config_mod", "critical", "persistence",
     "references Orcanium configuration files directly"),
...
# scan. `.skillignore` is the Orcanium-native name; `.clawhubignore` is honored
