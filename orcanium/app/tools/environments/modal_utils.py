"""Shared Orcanium-side execution flow for Modal transports.

This module deliberately stops at the Orcanium boundary:
- command preparation
...
from orcanium.app.tools.environments.base import BaseEnvironment
...
def wrap_modal_stdin_heredoc(command: str, stdin_data: str) -> str:
    ...
    marker = f"ORCANIUM_EOF_{uuid.uuid4().hex[:8]}"
