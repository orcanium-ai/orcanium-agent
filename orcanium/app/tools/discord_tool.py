...
when running on the Discord channel. Uses Discord REST API directly
with the bot token — no dependency on the gateway adapter's client.

Only included in the orcanium-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Orcanium-Agent (https://github.com/Orcanium/orcanium)",
        },
    )
