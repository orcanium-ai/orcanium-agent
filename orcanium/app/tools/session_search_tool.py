...
the get_anchored_view / get_messages_around primitives in orcanium.channel.compat.
...
# Third-party integrations tag their sessions with ORCANIUM_SESSION_SOURCE=tool;
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from orcanium.channel.compat import DEFAULT_DB_PATH
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Orcanium profile's database "
