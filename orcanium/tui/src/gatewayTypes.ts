...
export type GatewayEvent =
  | { payload?: { skin?: GatewaySkin }; session_id?: string; type: 'channel.ready' }
  ...
  | { payload: { line: string }; session_id?: string; type: 'channel.stderr' }
  | {
  ...
  | { payload?: { preview?: string }; session_id?: string; type: 'channel.protocol_error' }
