...
import type { ScrollBoxHandle } from '@Orcanium/ink'
import { evictInkCaches } from '@Orcanium/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ORCANIUM_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
