 ...
 *
 * Symptom: in `Orcanium --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@Orcanium/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using Orcanium --tui and as i type multiline my caret at the end will often ' +
