...
export default class Ink {
  ...
  // synchroorcaniumly in handleResize would leave the screen blank for the ~80ms
  ...
  // Fold synchroorcanium re-entry (selection fanout, onFrame callback)
  ...
  constructor(private readonly options: Options) {
    ...
    // synchroorcaniumly. Deferring to a microtask runs onRender after layout
    ...
    // existing synchroorcanium lastFrame() tests are unaffected.
   ...
   * with no side effects — call it synchroorcaniumly at click time so the
  ...
  unmount(error?: Error | number | null): void {
    ...
    // Clean up terminal modes synchroorcaniumly before process exit.
