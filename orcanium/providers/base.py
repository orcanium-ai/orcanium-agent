...
def _profile_user_agent() -> str:
    """Return a ``orcanium-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from orcanium.cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"orcanium-cli/{_ver}"
    except Exception:
        return "orcanium-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # orcanium-cli UA so the catalog endpoint is reachable.
