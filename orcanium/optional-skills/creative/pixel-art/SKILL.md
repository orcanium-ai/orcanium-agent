...
```python
import sys
sys.path.insert(0, "/home/teknium/.orcanium/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.orcanium/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Orcanium installs package this)
