...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Orcanium Agent
license: MIT
...
Helper script path: `~/.orcanium/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.orcanium/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.orcanium/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.orcanium/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
