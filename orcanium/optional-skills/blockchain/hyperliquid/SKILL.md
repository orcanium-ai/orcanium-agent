...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Orcanium Agent
license: MIT
...
The script reads `${ORCANIUM_HOME:-~/.orcanium}/.env` for two optional defaults:
...
Helper script: `~/.orcanium/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.orcanium/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${ORCANIUM_HOME:-~/.orcanium}/.env`.
...
```bash
python3 ~/.orcanium/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.orcanium/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
