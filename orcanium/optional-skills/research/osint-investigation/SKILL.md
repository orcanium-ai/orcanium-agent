...
author: Orcanium Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  orcanium:
...
# $ORCANIUM_OSINT_CACHE/icij/ (default: ~/.cache/orcanium-osint/icij/).
...
# Set ORCANIUM_OSINT_UA=your-app/1.0 (your@email) to identify yourself
