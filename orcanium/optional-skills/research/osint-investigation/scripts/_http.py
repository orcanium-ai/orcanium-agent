...
DEFAULT_UA = (
    "orcanium-osint-investigation/0.2 "
    "(+https://github.com/Orcanium/orcanium-agent; "
    "set ORCANIUM_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("ORCANIUM_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
