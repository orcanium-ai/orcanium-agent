...
Data file: $ORCANIUM_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ORCANIUM_HOME = Path(os.environ.get("ORCANIUM_HOME", Path.home() / ".orcanium"))
DATA_DIR = _ORCANIUM_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
