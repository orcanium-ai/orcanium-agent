...
4. Name the token (e.g., "Orcanium Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${ORCANIUM_HOME:-~/.orcanium}/.env`:
...
```bash
CANVAS="python $ORCANIUM_HOME/skills/productivity/canvas/scripts/canvas_api.py"
