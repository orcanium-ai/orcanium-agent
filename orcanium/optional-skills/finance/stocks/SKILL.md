...
version: 0.1.0
author: Mibay (Mibayy), Orcanium Agent
license: MIT
...
```
SCRIPT=~/.orcanium/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.orcanium/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
