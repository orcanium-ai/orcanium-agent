...
Built on channel startup, refreshed periodically (every 5 min), and saved to
~/.Orcanium/channel_directory.json.  The send_message tool reads this file for
...
from orcanium.channel.compat import atomic_json_write

logger = logging.getLogger(__name__)

DIRECTORY_PATH = get_orcanium_home() / "channel_directory.json"
...
def _build_from_sessions(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_orcanium_home() / "sessions" / "sessions.json"
