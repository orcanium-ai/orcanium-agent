...
Mirrors the Feishu onboarding pattern: synchroorcanium HTTP + a single public
...
scanner's *user_openid* — enough to fully configure the QQBot channel.
...
# ---------------------------------------------------------------------------
# Synchroorcanium HTTP helpers (mirrors Feishu _post_registration pattern)
# ---------------------------------------------------------------------------
