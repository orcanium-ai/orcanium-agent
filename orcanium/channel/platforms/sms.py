...
from orcanium.channel.platforms.helpers import redact_phone, strip_markdown
...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Orcanium channel adapter.

    Each inbound phone number gets its own Orcanium session (multi-tenant).
