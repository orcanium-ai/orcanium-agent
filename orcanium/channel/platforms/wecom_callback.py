...
Supports multiple self-built apps under one channel instance, scoped by
...
from orcanium.channel.platforms.base import BasePlatformAdapter, MessageEvent, MessageType, SendResult
from orcanium.channel.platforms.wecom_crypto import WXBizMsgCrypt, WeComCryptoError
...
class WecomCallbackAdapter(BasePlatformAdapter):
    ...
    async def _poll_loop(self) -> None:
        """Drain the message queue and dispatch to the channel runner."""
        while True:
