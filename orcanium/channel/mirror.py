...
Standalone -- works from CLI, cron, and channel contexts without needing
...
_SESSIONS_DIR = get_orcanium_home() / "sessions"
...
def mirror_to_session(
    ...
    Finds the channel session that matches the given platform + chat_id,
