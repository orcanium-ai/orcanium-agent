...
_PLATFORM_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    # "new"/"all" spam permanent lines in channels (orcanium-agent#14663).
    ...
    # Orcanium Cloud adapter doesn't implement edit_message yet, so we
...
def resolve_display_setting(
    ...
    platform_key : str
        ...
        ``_platform_config_key(source.platform)`` from channel/run.py.
    setting : str
    ...
    # that key controls only CLI terminal streaming; channel token streaming is
