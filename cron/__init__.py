"""
Cron job scheduling system for Orcanium Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    orcanium gateway install    # Install as a user service
    sudo orcanium gateway install --system  # Linux servers: boot-time system service
    orcanium gateway            # Or run in foreground
